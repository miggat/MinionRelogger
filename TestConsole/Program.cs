...
namespace TestConsole
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            Config.Singleton.GeneralSettings.SetGW2Path(@"C:\Guild Wars 2\GW2.exe");
            ...
            test.SetLoginName("xxx@gmail.com");
            ...
            test3.SetLoginName("xxx@gmail.com");
            test3.SetManuallyScheduled(false);
            test3.SetNoSound(true);
            test3.SetPassword("yyy");
            test3.SetSchedulingEnabled(true);
